...
class GameForm extends BaseGameForm
{
  ...
  public function configure()
  {
    ...
    $this->getWidgetSchema()->setHelps(array(
        ...
        'description' => '',
        'short_info' => ''.'|Краткий анонс игры, для публикации в общем списке.',
        ...
        'stop_datetime' => 'ГГГГ-ММ-ДД ЧЧ:ММ:СС.|В этот момент игра останавливается принудительно вне зависимости от оставшегося у команд игрового времени и/или реального момента начала игры.|<span class="warn">Указывать по серверному времени.</span>|<span class="warn">Дата должна отстоять от начала игры на интервал не меньший, чем сумма длительности игры и самой большой задержки старта команд.</span>|<span class="info">Рекомендуется зарезервировать время на ожидание между заданиями и/или предполагаемое пребывание команд в очередях.</span>',
        'finish_briefing_datetime' => 'ГГГГ-ММ-ДД ЧЧ:ММ:СС.|<span class="warn">Указывать по серверному времени.</span>',
        //Параметры новых задания
        'time_per_task' => 'мин.',
        'time_per_tip' => 'мин.',
        'try_count' => 'не&nbsp;более&nbsp;...&nbsp;.',
