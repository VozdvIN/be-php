...
class TeamStateForm extends BaseTeamStateForm
{
  public function configure()
  {
    ...
    $this->getWidgetSchema()->setHelps(array(
        ...
        'ai_enabled' => 'Если выключена, то каждое следующее задание должно назначаться вручную или выбираться самой командой.|Если задание не удастся выбрать автоматически, то для этой команды автоматизация будет отключена.'
    ));
  }
}
