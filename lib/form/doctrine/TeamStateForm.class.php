...
class TeamStateForm extends BaseTeamStateForm
{
  public function configure()
  {
    ...
    $this->getWidgetSchema()->setHelps(array(
        ...
        'ai_enabled' => 'При отключении каждое следующее задание должно назначаться вручную или выбраться самой командой.|Если задание не удастся выбрать, то для этой команды автоматический выбор будет отключен.'
    ));
  }
}
