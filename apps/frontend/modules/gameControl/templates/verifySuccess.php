...
<p>
	...
	<?php endif; ?>
	<span class="info info-bg pad-box box"><?php echo link_to('Повторить проверку', 'gameControl/verify?id='.$_game->id.'&returl='.Utils::encodeSafeUrl(url_for('gameControl/pilot?id='.$_game->id)), array('method' => 'post')); ?></span>
</p>
