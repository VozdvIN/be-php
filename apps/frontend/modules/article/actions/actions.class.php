...
class articleActions extends MyActions
{
	...
	protected function prepareShow()
	{
		...
		$this->_isModer = $this->_authenticated && ($this->sessionWebUser->can(Permission::ARTICLE_MODER, $this->_article->id));
		$this->_canEdit = $this->_authenticated && ($this->_article->canBeManaged($this->sessionWebUser));    
	}
