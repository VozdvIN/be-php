...
<?php endif ?>
<div>
  <div><span class="warn">При подтверждении заявки команда будет зарегистрирована в игровом проекте автора заявки.</span></div>
  <div><span class="info">Позже капитан команды может сменить игровой проект команды.</span></div>
</div>
