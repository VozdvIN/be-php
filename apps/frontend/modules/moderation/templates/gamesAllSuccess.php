...
<?php include_partial('menuGames', array('_activeItem' => 'Все')) ?>

<?php if ($_games->count() == 0): ?>
<p>
	Нет игр ни в одном из игровых проектов.
</p>
<?php else: ?>
<table class="no-border">
	<thead><tr><th>Название</th><th>Проект</th><th>Брифинг</th><th>Старт</th><th>Стоп</th><th>Итоги</th></tr>
	</thead>
	<tbody>
