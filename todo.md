...
+ Закрытие доступа посторонних к проектируемым играм.

+ В общем списке игр не показывать не анонсированные игры.

Отображение анонсов анонсированных игр, вместо их списка.
...
Доступ модератора к проектируемым играм (Игры/Разработка).
...
Код таймеров размещать непосредственно в месте использования (шаблоном).
