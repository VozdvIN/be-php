...
Автор игры не может сменить команду организатора на ту, в которой он не капитан
    - при записи игры не проходит проверка на право изменения

# Improvement

## Текущее

Регистронезависимая проверка русских ответов

Переход на афишу игры со страницы задания
