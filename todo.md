...
! Странно работают команды изменения статуса игрока
...
Убрать комментарий про русские ответы в редакторе ответов

Анкета/Игры - неправильный комментарий про "показаны команды из..."
...
## Дерево
    ...
    +Участники
        ...
        +Игры
            ...
            +Организатор
                [Создать игру]
    Модерирование //все данные ниже - без деления по проектам
