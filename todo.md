...
! В истории заданий на странице текущего задания подсказка к стартовавшему заданию видна раньше подтверждения прочтения
...
Кнопки "Добавить", "Редактировать", "Удалить" и похожие по возможности разместить вверху страниц 
    - тестировать

Управление игрой
    - назначение следующего задания организаторами возвращает на страницу маршрута
    - выбор следующего задания командой возвращает на страницу задания команды
